...
{
    public class FileCM023_03 : FileBase
    {
        private CM023DocManager documentManager_cm023_03;

        public FileCM023_03(CM023DocManager dm)
        {
        ...
        {
            InitQueInfo(dm, readFolderName_cm023_03, waittingFolderName_cm023_03);
            dm.t = new Thread(new FileCM023_03(dm).Run);
            dm.t.Start();
        }
            ...
            while (true)
            {
                if (documentManager_cm023_03.IsDoctumentAvailable)
                {
                    ...
                    try
                    {
                        ...
                        MoveFile(doc.Name, waittingFolderName_cm023_03, completeFolderName_cm023_03);
                    }
                    catch (Exception ex)
                    {
                        BaseCode.WriteLog(ex.Message + "订单号：" + doc.HisKey);
                        MoveFile(doc.Name, waittingFolderName_cm023_03, exceptionFolderName_cm023_03);
                    }
                }
                else
                {
                    InitQueInfo(documentManager_cm023_03, readFolderName_cm023_03, waittingFolderName_cm023_03);
                }
            }
        }
          
        static string readFolderName_cm023_03 = "D://Distribution//CM023_03//";
        static string exceptionFolderName_cm023_03 = "D://Distribution//CM023_03//";
        static string completeFolderName_cm023_03 = "D://Distribution//CM023_03//Actived//";
        static string waittingFolderName_cm023_03 = "D://Distribution//CM023_03//waitting//";
    }
}
