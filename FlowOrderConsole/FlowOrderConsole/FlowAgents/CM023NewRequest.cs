...
{
    public class CM023NewRequest : AgentBase
    {
        public CM023NewRequest()
        {
            App = "80dbfb983e8c4f31b85b689acbb27630";
            AppSec = "3b718add52894f388e7ae7f61acaa216";
            RequestUrl = "http://cqdata.4ggogo.com/web-in/boss/charge.html";
        }
  ...
  + "</ChargeData></Request>";
        ...
        private string GetToken()
        {
            try
            {
                ...
                var authJson = HttpWebRequestTools.CM023NewAuthHttpPost0915(authUrl, paramStr);
                InitToken(authJson);
