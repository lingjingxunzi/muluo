...
namespace MONO.Orders.FlowAgents
{
    public class SxdRequest : AgentBase
    {
        ...
        {
            var url_parm = GetUrlParamStr(agentParamBase.MobilePhone, agentParamBase.ProductId, agentParamBase.HistoriesKey);
        ...
        private string GetUrlParamStr(string mobile, string produceid, string TransNo)
        {
            var url = "mobile=" + mobile + "&productId=" + produceid + "&notifyUrl=" + ConfigurationSettings.AppSettings["SxdNotifyUrl"] + "&passParm=" + TransNo;
