<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterMobilePhone.aspx.cs"
    Inherits="MONO.Distribution.UI.ComPage.EnterMobilePhone" %>
...
<body>
    ...
    <div class="main">
        ...
        <div class="siBtn">
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btnm" Text="下一步" OnClick="btnEnterPhone_OnClick"></asp:LinkButton>
        </div>
        <div class="msMi">
            <p class="mTi">
                说明</p>
