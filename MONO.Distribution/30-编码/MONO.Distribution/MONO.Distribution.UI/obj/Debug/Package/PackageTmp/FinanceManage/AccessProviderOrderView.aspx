<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessProviderOrderView.aspx.cs"
    Inherits="MONO.Distribution.UI.FinanceManage.AccessProviderOrderView" %>
            ...
            <div>
                <ul>
                    <li style="text-align: center; font-size: 22px; font-weight: bold">
                        <asp:Label ID="lblTitle" runat="server"></asp:Label>接入商订购总计</li>
