<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSettingEdit.aspx.cs"
    Inherits="MONO.Distribution.UI.Sys.UserSettingEdit" %>
            ...
            <div id="tab1" class="tabson">
                <ul class="forminfo" style="margin-left: 50px;">
                    <li>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*账户名不能为空！" CssClass="red"
                            ControlToValidate="txtAccounts"></asp:RequiredFieldValidator>
                    </li>
                    <li>
                        <label class="title">
                            *密码：
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*密码不能为空！" CssClass="red"
                            ControlToValidate="txtScrect"></asp:RequiredFieldValidator>
                    </li>
                    <li>
                        <label class="title">
                            用户组：
                        ...
                        <table id="tbFlows" class="tablelist">
                            ...
                            <asp:Repeater runat="server" ID="repFlowList">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# "<input type=\"checkbox\" runat=\"server\" id=\"ckbFlow_" + Eval("FlowKey") + "\" />"%>
                                            <%#Eval("FlowName") %>
                                        </td>
                                        <td>
                                            <%#Eval("StandardPrice") %>
                                        ...
                                        <td id='<%#Eval("StandardPrice")+"_"+Eval("FlowKey")  %>'>
                                            <input type="text" id='dis_"+<%#Eval("FlowKey") %>+"' onchange="dischanged(this);" />
                                        </td>
