<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountApplyReviews.aspx.cs"
    Inherits="MONO.Distribution.UI.FinanceManage.AccountApplyReviews" %>
...
<body>
    ...
    <div class="rightinfo">
        ...
        <asp:GridView ID="gvDisList" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" ID="lbtnDetailsInfo" OnClientClick='<%#Eval("AccountAddApplyKey","javascript:openWindow(\"编辑用户信息\",\"AccountApplyReviewEdit.aspx?Command=Edit&Id={0}\",\"750\",\"480\");return false;") %>'>查看</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
      ...
      <div class="tip">
        <div class="tiptop">
            <span id="editTitle">审核</span><a onclick="closeWindow(false);"></a></div>
        <div class="tipinfo">
            <iframe id="editFrame" src="/FinanceManage/AccountApplyReviewEdit.aspx" width="560px" height="350px"></iframe>
        </div>
    </div>
    </form>
</body>
