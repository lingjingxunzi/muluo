<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentFlowAssigned.aspx.cs"
    Inherits="MONO.Distribution.UI.AgentManage.AgentFlowAssigned" %>
    ...
    <div>
        <ul class="forminfo" style="margin-left: 50px;">
            ...
            <li>
                                ...
                                <tr>
                                    ...
                                    <td id='<%#Eval("StandardPrice")+"_"+Eval("FlowKey")  %>'>
                                        <input type="text" id='dis_"+<%#Eval("FlowKey") %>+"' onchange="dischanged(this);"
                                            value='<%# (Convert.ToBoolean(Eval("IsExists"))?Eval("DiscountValue"):"100")  %>' />
                                    </td>
                ...
                <li>
                    <asp:Button runat="server" ID="btnSave" CssClass="scbtn" Text="保存" OnClientClick="beforeSave();"
