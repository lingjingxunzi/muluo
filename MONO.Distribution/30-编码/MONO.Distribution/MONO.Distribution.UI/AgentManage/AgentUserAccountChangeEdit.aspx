<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentUserAccountChangeEdit.aspx.cs"
    Inherits="MONO.Distribution.UI.AgentManage.AgentUserAccountChangeEdit" %>
    ...
    <div>
        <ul class="forminfo">
            ...
            <li id="tr_turnout" runat="server">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*转出积分不能为空！"
