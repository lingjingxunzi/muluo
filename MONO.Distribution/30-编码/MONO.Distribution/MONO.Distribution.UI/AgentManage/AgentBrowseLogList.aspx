<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentBrowseLogList.aspx.cs" Inherits="MONO.Distribution.UI.AgentManage.AgentBrowseLogList" %>
        ...
        <div class="tools">
            <ul class="seachform1" style="width: 1000px;">
                <li>
                    ...
                    <div  class="vocation" >
                        <asp:DropDownList runat="server" CssClass="select1" ID="ddlUsers"/>
                    </div>
