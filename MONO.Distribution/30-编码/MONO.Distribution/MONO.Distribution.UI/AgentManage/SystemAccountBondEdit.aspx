<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemAccountBondEdit.aspx.cs"
    Inherits="MONO.Distribution.UI.AgentManage.SystemAccountBondEdit" %>
    ...
    <div>
        <ul class="forminfo">
            ...
            <li id="tr_turnout" runat="server">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*保证金不能为空！"
