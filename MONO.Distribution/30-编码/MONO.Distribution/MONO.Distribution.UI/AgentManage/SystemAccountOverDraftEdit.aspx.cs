...
{
    public partial class SystemAccountOverDraftEdit : EditPageBase
    {
        public SystemAccountOverDraftEdit()
        {
        ...
        private void BindBaseInfo()
        {
            ...
            txtCurrentLeft.Text = accountInfo.OverDraft.ToString();
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            var info = _systemAccountService.SelectSystemAccountByUserKey(int.Parse(Request.QueryString["UserKey"]));
            info.OverDraft = int.Parse(txtTurnOut.Text.Trim());
            _systemAccountService.UpdateSystemAccountForDraft(info);
