<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemFilling.aspx.cs"
    Inherits="MONO.Distribution.UI.AgentManage.SystemFilling" %>
        ...
        <ul class="forminfo">
            ...
            <li id="tr_turnout" runat="server">
                ...
                <asp:TextBox runat="server" CssClass="dfinput1" ID="txtTurnIn"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*转入积分不能为空！" CssClass="red"
                            ControlToValidate="txtTurnIn"></asp:RequiredFieldValidator>
            </li>
            <li style="margin-left: 120px;">
                <asp:Label runat="server" ID="lblError" Visible="False" CssClass="red"></asp:Label>
            </li>
            <li style="margin-left: 120px;">
